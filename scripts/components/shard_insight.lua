...
function Shard_Insight:SetAntlion(entity)
	...
	self:RegisterWorldDataFetcher("sinkholespawner", function ()
		return entity and entity.components.sinkholespawner and
			_G.Insight.descriptors.sinkholespawner and _G.Insight.descriptors.sinkholespawner.GetAntlionData and
			_G.Insight.descriptors.sinkholespawner.GetAntlionData(entity) or nil
	end)
...
function Shard_Insight:SetCrabKingSpawner(entity)
	...
	self:RegisterWorldDataFetcher("crabkingspawner", function ()
		return TheWorld.components.crabkingspawner and entity and _G.Insight.descriptors.crabkingspawner and _G.Insight.descriptors.crabkingspawner.GetCrabKingData(entity) or nil
	end)
