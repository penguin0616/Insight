...
-- weather.lua
local OnUpdate = TheWorld.net.components[((TheWorld.worldprefab == "forest" and "") or (TheWorld.worldprefab == "cave" and "cave") or "").."weather"].OnUpdate
if debug.getinfo(OnUpdate, "S").source ~= "scripts/components/weather.lua" then
...
local _preciptype = util.getupvalue(OnUpdate, "_preciptype")
local _moisturefloor = util.getupvalue(OnUpdate, "_moisturefloor")
local _moistureceil = util.getupvalue(OnUpdate, "_moistureceil")
local _moisturerate = util.getupvalue(OnUpdate, "_moisturerate")
local PRECIP_TYPES = util.getupvalue(OnUpdate, "PRECIP_TYPES")
local PRECIP_RATE_SCALE = util.getupvalue(OnUpdate, "PRECIP_RATE_SCALE")
