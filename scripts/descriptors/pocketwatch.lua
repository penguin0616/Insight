...
local function Describe(self, context)
	...
	if self.inst.prefab == "pocketwatch_heal" then
		description = string.format(context.lstr.oldager.age_change, ConvertHealthAmountToAge(TUNING.POCKETWATCH_HEAL_HEALING))
	end
