...
local function Hunter_OnDirtInvestigated(self, pt, doer, ...)
	...
	if IS_DST then
		...
		--mprint("looking for the hunt:", #module.active_hunts)
		for i,v in ipairs(module.active_hunts) do
			--mprint(i, v, v.lastdirt, v.lastdirt and v.lastdirt:GetPosition(), pt)
...
function module.OnServerLoad(self)
