...
local english = {
	...
	update_info = "Anchor information, shelter information, lightning blocker information. Bug fix for mods that replace antlion. Check changelog for more details.",
